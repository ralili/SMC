%%This function contains SMC code to optimize over the mu of the lognormal
%%priors, while running the simulations with the MEX file (C-compiled
%%code).
function [ev,gF,H] = SMC_toyMEX(meanlogpar)%evidence, gradient of the evidence, hessian of the evidence
%% Setup sampler
...
sigmanoise = 0.05;
meanlogpar
sigmalogpar=ones(1,length(meanlogpar))*0.3;
